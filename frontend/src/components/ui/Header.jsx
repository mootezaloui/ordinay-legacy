...
export default function HeaderBar() {
  ...
  return (
    <header className={`h-14 bg-[#f8fafc] dark:bg-[#0f172a] text-slate-800 dark:text-slate-100 transition-all duration-300 z-30 titlebar-offset-top sticky inset-x-0 md:fixed ${isCollapsed ? "md:left-20" : "md:left-64"}`}>
