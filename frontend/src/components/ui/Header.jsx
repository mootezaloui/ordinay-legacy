...
export default function HeaderBar() {
  ...
  return (
    <header className={`h-14 bg-white/70 dark:bg-slate-900/70 backdrop-blur-sm text-slate-800 dark:text-slate-100 transition-all duration-300 z-30 titlebar-offset-top sticky inset-x-0 md:fixed ${isCollapsed ? "md:left-20" : "md:left-64"}`}>
