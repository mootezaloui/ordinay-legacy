        ...
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-3xl mb-8">
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
              ...
              <h3 className="font-semibold text-slate-900 dark:text-white mb-1">Recherche</h3>
            ...
            <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
              ...
              <h3 className="font-semibold text-slate-900 dark:text-white mb-1">Analyse</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400">
          ...
          <p className="mt-8 text-xs text-slate-500 dark:text-slate-400">
            🔒 Toutes les conversations sont sécurisées et confidentielles
          </p>
        </div>
      </ContentSection>
    </PageLayout>
