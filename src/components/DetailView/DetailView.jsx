 ...
 * Can be used for any entity: clients, dossiers, tasks, sessions, etc.
 * 
 * Usage:
 * <DetailView entityType="client" />
 * <DetailView entityType="dossier" />
 */
export default function DetailView({ entityType }) {
  ...
  const renderTabContent = () => {
    ...
    switch (tabConfig.component) {
      case "overview":
        return <OverviewTab data={data} config={config} isEditing={isEditing} />;
      case "documents":
        return <DocumentsTab data={data} config={config} />;
      case "timeline":
        return <TimelineTab data={data} config={config} />;
      case "notes":
        return <NotesTab data={data} config={config} />;
      case "relatedItems":
        return <RelatedItemsTab data={data} config={config} tabConfig={tabConfig} />;
      case "financials":
