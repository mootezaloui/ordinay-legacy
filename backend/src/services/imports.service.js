...
const CLIENT_FIELD_ALIASES = {
  name: ["name", "clientname", "fullname", "full_name", "client", "nom", "nomcomplet"],
  first_name: ["first_name", "firstname", "prenom", "givenname"],
  last_name: ["last_name", "lastname", "nomdefamille", "familyname", "surname"],
  email: ["email", "e_mail", "mail", "courriel"],
  phone: ["phone", "telephone", "tel", "mobile", "gsm", "phone1", "phone_number"],
  alternate_phone: ["alternate_phone", "alt_phone", "phone2", "telephone2", "secondary_phone"],
  address: ["address", "adresse", "street", "location"],
  status: ["status", "etat", "state"],
  cin: ["cin", "id", "id_number", "cni", "national_id"],
  date_of_birth: ["date_of_birth", "dateofbirth", "dob", "birthdate", "datenaissance"],
  profession: ["profession", "job", "occupation"],
  company: ["company", "societe", "entreprise"],
  tax_id: ["tax_id", "taxid", "matriculefiscal", "fiscal_id"],
  notes: ["notes", "note", "comment", "comments", "remarks"],
  join_date: ["join_date", "joindate", "registrationdate", "dateinscription"],
};
